        ...
        <div class="container-fluid">
            <form class="row g-3" action="/ctes">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" name="valor_cte" id="valor_cte" placeholder="R$" disabled value="{{number_format($cte->valor_cte, 2)}}">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" name="valor_nf" id="valor_nf" disabled value="{{number_format($cte->valor_nf, 2)}}">
                </div>
                <div class="col-md-4">
    ...
    @else
        <div class="container-fluid">
            <form class="row g-3" action={{ "/ctes/atualizar/$cte->id" }}>
                ...
                <div class="col-md-4">
                    <label for="valorcte" class="form-label">Valor CT-e</label>
                    <input type="number" class="form-control" name="valor_cte" id="valor_cte" placeholder="R$" value="{{number_format($cte->valor_cte, 2)}}">
                </div>
                <div class="col-md-4">
                    <label for="qtdevol" class="form-label">Quantidade de volumes</label>
